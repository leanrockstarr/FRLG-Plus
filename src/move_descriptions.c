...
const u8 gMoveDescription_AirSlash[] = _("The user attacks\nwith a blade of\nair. It may make\nthe foe flinch.");
...
const u8 gMoveDescription_BugBuzz[] = _("null");
const u8 gMoveDescription_BulletPunch[] = _("The user strikes\nas fast as a\nbullet. It is sure\nto strike first.");
const u8 gMoveDescription_DarkPulse[] = _("The user releases\na dark wave that\nmay also make\nthe target flinch.");
const u8 gMoveDescription_DragonPulse[] = _("The user attacks\nwith a shock wave\ngenerated from\nits mouth.");
const u8 gMoveDescription_DrainPunch[] = _("A harsh punch that\nabsorbs half the\ndamage it inflicted\nto restore HP.");
const u8 gMoveDescription_EarthPower[] = _("The user causes\neruptions under the\nfoe. It may lower\ntheir SP.DEF stat.");
const u8 gMoveDescription_EnergyBall[] = _("null");
const u8 gMoveDescription_FlashCannon[] = _("The user attacks\nthe foe with light.\nIt may lower their\nSP.DEF stat.");
const u8 gMoveDescription_FocusBlast[] = _("null");
const u8 gMoveDescription_GunkShot[] = _("null");
const u8 gMoveDescription_IronHead[] = _("null");
const u8 gMoveDescription_LeafStorm[] = _("null");
const u8 gMoveDescription_NightSlash[] = _("null");
const u8 gMoveDescription_PoisonJab[] = _("null");
const u8 gMoveDescription_RockPolish[] = _("null");
const u8 gMoveDescription_SeedBomb[] = _("null");
